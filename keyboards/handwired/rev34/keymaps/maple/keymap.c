...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAPLE] = LAYOUT_ortho_4x10(
        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_LSFT, KC_INS,  KC_HOME, KC_PGUP,
        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_LCTL, KC_DEL,  KC_END,  KC_PGDN,
        XXXXXXX, XXXXXXX, XXXXXXX, LOWER,   KC_SPC,  KC_ENT,  RAISE,   XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_RAISE] = LAYOUT_ortho_4x10(
        ...
        KC_F5,   KC_F6,   KC_F7,   KC_F8,   XXXXXXX, KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
    ...
    [_ADJUST] = LAYOUT_ortho_4x10(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, COLEMAK, MAPLE,   XXXXXXX, XXXXXXX,
...
bool process_record_user(uint16_t keycode, keyrecord_t* record) {
    ...
    case MAPLE:
        if (record->event.pressed) {
            eeconfig_update_default_layer(1UL << _MAPLE);
            default_layer_set(1UL << _MAPLE);
        }
        return false;
    case LOWER:
        if (record->event.pressed) {
