...
/*
    ...
    * `iota_gfx_task_user()` is no longer needed. Instead, `bool oled_task_user(void)` is provided.
    ...
    以下のコードは、SSD1306OLED から OLED_ENABLE
   に移行する助けになるようにサンプルとして残してあります。
...
static void render_layer_status(struct CharacterMatrix* matrix) {
    // Define layers here, Have not worked out how to have text displayed for each layer. Copy down
    // the number you see and add a case for it below
    char buf[10];
