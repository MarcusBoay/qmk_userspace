...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, LOWER,   KC_LGUI, KC_LALT, RAISE,   KC_SPC,  SH_MON,  LOWER,   KC_LGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, RAISE
    ),
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_LCTL, LOWER,   KC_LGUI, KC_LALT, RAISE,   KC_SPC,  SH_MON,  LOWER,   KC_LGUI, KC_0,    KC_DOT,  XXXXXXX, XXXXXXX, RAISE
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_RCTL, LOWER,   KC_LGUI, KC_LALT, RAISE,   KC_SPC,  SH_MON,  LOWER,   KC_LGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, RAISE
    ),

    [_ADJUST] = LAYOUT(
        KC_ESC,  XXXXXXX, RGB_HUD, RGB_HUI, XXXXXXX, XXXXXXX,                   XXXXXXX, QWERTY,  COLEMAK, XXXXXXX, XXXXXXX, QK_MAGIC_TOGGLE_CTL_GUI,
